...
public class Planet extends NaturalSatellite {
    ...
    public Planet(String name, double mass, double radius, double semiMajorAxis, double eccesentricity, double orbitalPeriod, CelestialBody centralCelestialBody ){
        super(name,mass,radius, semiMajorAxis,eccesentricity,orbitalPeriod, centralCelestialBody);
    }
